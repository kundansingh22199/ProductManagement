<%@ Page Title="" Language="C#" MasterPageFile="~/AdminModule/Master.Master" AutoEventWireup="true" CodeBehind="TotalSales.aspx.cs" Inherits="B2CAdmin.AdminModule.TotalSales" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Total Sales List</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="DashBoard.aspx">Home</a></li>
                            <li class="breadcrumb-item active">Total Sales List</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <asp:DropDownList runat="server" ID="ddlSearch" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlSearch_SelectedIndexChanged">
                            ...
                            <asp:ListItem Value="BySellarId" Text="Sellar Id"></asp:ListItem>
                            <asp:ListItem Value="BySellarMobile" Text="Sellar Mobile No"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                            ...
                            <ItemTemplate>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="Label10" runat="server" Text='<%# Eval("MobileNo") %>'></asp:Label>
                                        </td>
                                        <td>
