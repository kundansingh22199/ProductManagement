...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                            ...
                                            <div class="col-md-7">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <asp:DropDownList ID="ddlProductSubCatogery" class="custom-select form-control-border" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlProductSubCatogery_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" style="padding: 0px; margin: 0px; padding-right: 10px; padding-left: 10px; display: block">
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:Label runat="server" ID="Label1">Brand Name<span style="color:red"><b>*</b></span></asp:Label>
                                                        <div class="input-group mb-2">
                                                            <asp:DropDownList ID="ddlBrand" class="custom-select form-control-border" runat="server">
                                                            </asp:DropDownList>
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text" style="padding: 0px; margin: 0px; padding-right: 10px; padding-left: 10px; display: block">
                                                                    <i class="fas fa-plus" style="position: relative; top: 5px" data-toggle="modal" data-target="#BrandModel"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <!-- Sub Catogery Modal -->
    <div id="BrandModel" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:Label runat="server" ID="Label6" for="">Catogery Type</asp:Label>
                            <asp:DropDownList ID="ddlBrandCatogery" class="custom-select form-control-border mb-2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlBrandCatogery_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="col-sm-12">
                            <asp:Label runat="server" ID="Label11" for="">SubCatogery Type</asp:Label>
                            <asp:DropDownList ID="ddlBrandSubCatogery" class="custom-select form-control-border mb-2" runat="server">
                            </asp:DropDownList>
                        </div>
                        <div class="col-sm-12">
                            <asp:Label runat="server" ID="Label9" for="">Brand Name</asp:Label>
                            <asp:TextBox runat="server" ID="txtBrand" placeholder="Enter Brand Name" class="form-control mb-2"></asp:TextBox>
                        </div>
                        <div class="col-sm-3">
                            <asp:Button runat="server" ID="btnBrand" class="btn btn-primary mb-2" Text="ADD" OnClick="btnBrand_Click" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script type="text/javascript">
        function ShowBrandPopup() {
            ...
            $("#BrandModel").css('background', 'inherit');
        }
