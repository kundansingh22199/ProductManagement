                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <asp:Image runat="server" ID="UserImg" class="img-size-50 img-circle" Style="height: 150px; width: 150px;" />
                            <%--<img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin" class="rounded-circle" width="150">--%>
                            <div class="mt-3">
                                <h3><span runat="server" id="lblName"></span></h3>
                                <h6><span runat="server" id="lblUserType"></span></h6>
                                <%--<h6><span runat="server" id="lblMobile"></span></h6>--%>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary" runat="server" id="lblFullName">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">Email</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblEmail">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary" runat="server" id="lblDob">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">Gender</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblGender">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary" runat="server" id="lblPhone">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">Address</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblAddress">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary" runat="server" id="lblCity">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">State</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblState">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-2">
                                <h6 class="mb-0">Addhar No</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblAddhar">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">Pan Card No</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblPan">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary" runat="server" id="lblCompany">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">GstIn No</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblGstin">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-secondary" runat="server" id="lblBranch">
                            </div>
                            <div class="col-sm-2">
                                <h6 class="mb-0">Store Name</h6>
                            </div>
                            <div class="col-sm-4 text-secondary" runat="server" id="lblStore">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <asp:Button runat="server" ID="btnEdit" class="btn btn-primary" Text="Edit" OnClick="btnEdit_Click" />
                            </div>
                        </div>
                    </div>
                </div>
