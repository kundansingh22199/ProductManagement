                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <asp:Label runat="server" ID="Label5">User Type</asp:Label>
                                        <asp:DropDownList ID="ddlUserType" class="custom-select form-control-border mb-2" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Label runat="server" ID="Label8">State</asp:Label>
                                    ...
                                    <div class="col-sm-4">
                                        <asp:Label runat="server" ID="Label9">City</asp:Label>
                                        <asp:DropDownList ID="ddlCity" class="custom-select form-control-border mb-2" runat="server">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Label runat="server" ID="Label10">Pincode</asp:Label>
                                    ...
                                    <div class="col-sm-4">
                                        <asp:Label runat="server" ID="Label7">Address</asp:Label>
                                        <asp:TextBox runat="server" ID="txtAddress" placeholder="Enter Address" class="form-control mb-2"></asp:TextBox>
                                    </div>
                                    <div class="col-sm-4">
                                        <asp:Label runat="server" ID="Label3">Addhar Card</asp:Label>
